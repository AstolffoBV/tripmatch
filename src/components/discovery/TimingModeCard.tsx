...
export default function TimingModeCard({
  ...
  return (
    <button
      ...
      onClick={onClick}
      className={`group relative min-h-24 w-full cursor-pointer overflow-hidden rounded-[1.35rem] border px-3.5 py-3 text-left shadow-sm transition duration-200 focus-visible:outline-2 focus-visible:outline-offset-3 focus-visible:outline-[#1b7c83] motion-safe:hover:-translate-y-0.5 motion-reduce:transform-none motion-reduce:transition-none sm:px-4 dark:focus-visible:outline-[#83d9d2] ${
        selected
